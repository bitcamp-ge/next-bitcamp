  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="BitCamp - სწავლა და ბრძოლა 🔥✊">
          <img src="/logo-trans.png" alt="" style={{maxWidth: 37}}/>
        </Link>
      </div>
...
export function Layout({ children, title, tableOfContents }) {
  ...
  return (
    <>
      ...
      <div id='content' className="relative mx-auto flex max-w-8xl justify-center sm:px-2">
          
        <div className="min-w-0 max-w-2xl flex-auto px-9 py-16 lg:max-w-none lg:pr-0 ">
          <article>
            {(title || section) && (
